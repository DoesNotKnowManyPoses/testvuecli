...
function createLivePanelVue () {
  var liveVue = new Vue({
    ...
    data: {
      ...
      livenumber: 10000,
      updatesnum: 12345,
      biglivelists: [{imagesrc: './static/hahaha.jpg', contentsrc: './static/bilibili_recommend3.jpg', host: '葡萄美酒夜光杯', ahreflink: 'http', number: '3333', desc: '不知明镜里，何处得秋霜。', info: '战争·出战'}, {imagesrc: './static/bilibili_recommend2.jpg', contentsrc: './static/movablevideo4.jpg', host: '葡萄美酒夜光杯', ahreflink: 'http', number: '3333', desc: '欲渡黄河冰塞川，将登太行雪满山', info: '战争·出战'},
        {imagesrc: './static/bili_live1.jpg', contentsrc: './static/bilibili_recommend2.jpg', host: '黑云压城城欲摧', ahreflink: 'http', number: '3333', desc: '王师北定中原日', info: '战争·出战'}, {imagesrc: './static/bilibili_recommend2.jpg', contentsrc: './static/bilibili_recommend3.jpg', host: '琵琶一曲断', ahreflink: 'http', number: '3333', desc: '闲来垂钓碧溪上，忽复乘舟梦日边', info: '战争·出战'}, {imagesrc: './static/bilibili_recommend3.jpg', contentsrc: './static/movablevideo3.jpg', host: '不眠是征人', ahreflink: 'http', number: '3333', desc: '黄沙百战穿金甲，不破楼兰终不还。', info: '战争·出战'},
